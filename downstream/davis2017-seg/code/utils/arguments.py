...
def test_args():
    ...
    # Datasets
    ##############################################################################################################################################
    parser.add_argument('--model-type', default='triplemae_vits16', type=str)
    parser.add_argument('--resume', default='', type=str, metavar='PATH',
                        help='path to latest checkpoint (default: none)')
    parser.add_argument('--save-path', default='/home/jiangzhouqiang/projects/repro_videowalk/results/T005_K10_R12_V20_480_880_triplemae_vits16_triplemae_train_6_ep50', type=str)
    ##############################################################################################################################################
    ...
    ##############################################################################################################################################
    parser.add_argument('--cropSize', default=-1, type=int, help='resizing of test image, -1 for native size')
    parser.add_argument('--filelist', default='/home/jiangzhouqiang/projects/repro_videowalk/davis_vallist_480_880.txt', type=str)
    ##############################################################################################################################################
